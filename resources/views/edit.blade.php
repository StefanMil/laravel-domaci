<x-app-layout>
    ...
    <x-slot name="header">
        ...
        <h2 class="font semibold text-xl text-gray-800 leading-tight edit-title">
            {{$course->title}}
        </h2>
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-5">
                <form action="/courses/edit-course" method="POST">
                    <div class="form-group">
                        <input type="hidden" id="id" name="id" value="{{$course->id}}"><br>
                    ...
                    <div class="form-group">
                        <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Edit Course</button>
                    </div>
                    {{ csrf_field() }}
                </form>
            </div>    
